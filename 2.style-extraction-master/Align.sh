...
#$ProgramFolder/MusicXMLToHMM $RelCurrentFolder/${I1}.xml $RelCurrentFolder/${I1}_hmm.txt
#$ProgramFolder/MusicXMLToFmt3x $RelCurrentFolder/${I1}.xml $RelCurrentFolder/${I1}_fmt3x.txt

$ProgramFolder/ScorePerfmMatcher $RelCurrentFolder/${I1}_hmm.txt $RelCurrentFolder/${I2}_spr.txt $RelCurrentFolder/${I2}_pre_match.txt 0
